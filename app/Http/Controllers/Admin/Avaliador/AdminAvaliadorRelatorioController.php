...
class AdminAvaliadorRelatorioController extends Controller
{
    ...
    {
          $avaliadores = Avaliador::whereHas('projeto', function($q){
            $q->where('ano', '=', date('Y'));
        })->with('projeto')->orderBy('name', 'asc')->get();
    ...
    {
        /*caso dê erro de proxy, provavelmente é por causa do tamanho do pdf;
          para resolver, pode-se remover algumas informações da view nos dados pessoais, por exemplo */
