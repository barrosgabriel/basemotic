...
class EscolaCreateFormRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'rua'                   => 'required|string|between:3,100',
    ...
    public function messages()
    {
        return [
            ...
            'tipo.required' => 'Selecione se a escola é particular ou pública',
            ...
            'rua.between' => 'Insira uma rua que tenha entre 3 e 100 caracteres!',
