...
@section('breadcrumb')
    ...
    <a href="{{route ('admin.avaliacao.projetos-avaliados')}}" class="breadcrumb">Projetos avaliados</a>
@endsection

@section('content')

@section('titulo-header', 'Projetos avaliados')

@section('conteudo-header', 'Esses são os projetos que já foram avaliados.')
...
<div class="section container">
    <div class="card-panel">
        ...
        <div class="center-align">
            <div class="chip">
                Atualmente, {{$quantidade}} projetos já foram avaliados.
