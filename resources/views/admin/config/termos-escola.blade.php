                    ...
                    <div class="card small blue darken-4">
                        <form enctype="multipart/form-data" method="post"
                            ...
                            <div class="card-action">
                                ...
                                <a class="btn" target="_blank" href="{{url('termos/termo-maior-motic.pdf')}}">Visualizar</a>
                            </div>
                        </form>
                    </div>
                </div>
                ...
                <div class="col s12 m12">
                    <div class="card small red darken-4">
                        <form enctype="multipart/form-data" method="post"
                            ...
                            <div class="card-action">
                                <button class="btn" type="submit">Enviar</button>
                                <a class="btn" target="_blank" href="{{url('termos/termo-menor-motic.pdf')}}">Visualizar</a>
                            </div>
                        </form>
                    </div>
                </div>
                        ...
                        <form enctype="multipart/form-data" method="post"
                            ...
                            <div class="card-action">
                                ...
                                <a class="btn" target="_blank"
                                   href="{{url('termos/contrato-convivencia-motic.pdf')}}">Visualizar</a>
                            </div>
                        </form>
                    </div>
                </div>
