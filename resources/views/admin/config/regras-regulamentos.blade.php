                    ...
                    <div class="card small blue darken-4">
                        <form enctype="multipart/form-data" method="post"
                            ...
                            <div class="card-action">
                                ...
                                <a class="btn" target="_blank" href="{{url('regras/regras-motic.pdf')}}">Visualizar</a>
                            </div>
                        </form>
                    </div>
                </div>
                        ...
                        <form enctype="multipart/form-data" method="post"
                            ...
                            <div class="card-action">
                                ...
                                <a class="btn" target="_blank"
                                   href="{{url('regulamentos/regulamento-motic.pdf')}}">Visualizar</a>
                            </div>
                        </form>
                    </div>
                </div>
                    ...
                    <div class="card small green darken-4">
                        <form enctype="multipart/form-data" method="post"
                            ...
                            <div class="card-action">
                                <button class="btn" type='submit'>Enviar</button>
                                <a class="btn" target="_blank"
                                   href="{{url('termos/ficha-de-avaliacao-motic.pdf')}}">Visualizar</a>
                            </div>
                        </form>
                    </div>
                </div>
