...
@section('titulo-header', 'Avaliações')

@section('conteudo-header', 'Aqui você pode configurar o período que os avaliadores poderão ver os projetos designados a eles e avaliar os mesmos.')
