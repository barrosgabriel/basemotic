...
@section('titulo-header', 'Avaliadores Validação')

@section('conteudo-header', 'Esses são os avaliadores disponíveis para validação no sistema!')
...
<div class="section container">
    <div class="card-panel">
        ...
        <div class="center-align">
            <div class="chip">
                Existem {{$quantidade}} avaliadores pendente validação no sistema.
                <i class="close material-icons">close</i>
            </div>
        </div>
        <div class="row">
            @includeIf('_layouts._avaliador._tabela-avaliador-validacao')
        </div>
