        ...
        <div class="row">
            ...
            <form class="col s12" method="POST" enctype="multipart/form-data"
                ...
                <div class="row">
                    ...
                    <p>
                        Tipo de escola:
                        <input class="with-gap" name="tipo" value="municipal" type="radio" id="test1" @if(isset($escola) and $escola->tipo == "municipal") checked @endif/>
                        <label for="test1">Municipal</label>
                        <input class="with-gap" name="tipo" value="estadual" type="radio" id="test2" @if(isset($escola) and $escola->tipo == "estadual") checked @endif/>
                        <label for="test2">Estadual</label>
                        <input class="with-gap" name="tipo" value="privada" type="radio" id="test3" @if(isset($escola) and $escola->tipo == "privada") checked @endif/>
                        <label for="test3">Privada</label>
                    </p>
                </div>
                ...
                <div class="row">
                    <div class="input-field col s12 m6 l6">
                        ...
                        <input class="validate tooltipped" data-position="top" data-delay="50"
                               data-tooltip="Somente números e no máximo 8 números" id="cep" type="number"
                               name="cep" data-length="8"
