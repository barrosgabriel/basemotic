...
@section('breadcrumb')
    <a href="{{route ('escola.projeto')}}" class="breadcrumb">Home</a>
                            ...
                            <select multiple name="disciplina_id[]">
                                ...
                                @forelse ($disciplinas as $disciplina)
                                    <option value="{{$disciplina->id}}"
                                            @foreach($projeto->disciplina as $d) @if($disciplina->name == $d->name) selected @endif @endforeach>{{$disciplina->name}}</option>
                                @empty
                    ...
                    <div class="row">
                        <div class="input-field col s12 m12 l12">
                            ...
                            <select name="escola_id" id="escolaprojeto">
                                ...
                                <option selected value="{{$escola->id}}">{{$escola->name}}</option>
                            </select>
                            <label>Escola *</label>
                        </div>
                    </div>
