...
@section('breadcrumb')
    ...
    <a href="{{route ('escola.professor.certificadosOrientadores')}}" class="breadcrumb">Certificados Orientadores</a>
@endsection

@section('content')

@section('titulo-header', 'Gerar certificado para orientadores')

@section('conteudo-header', 'Esses são os professores orientadores cadastrados na MOTIC ' . date('Y') . '!')
...
<div class="section container">
    <div class="card-panel">
        ...
        <div class="row">
            @includeIf('_layouts._professor._tabela-orientador-certificados')
        </div>
