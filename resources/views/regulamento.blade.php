    ...
    <div class="container">
        <div class="card-panel">
            ...
            <div class="collection">
                <a target="_blank" href="{{url('regulamentos/regulamento-motic.pdf')}}" class="collection-item">  <i class="material-icons">picture_as_pdf</i> Regulamento MOTIC São Leopoldo</a>
                <a target="_blank" href="{{url('regras/regras-motic.pdf')}}" class="collection-item">  <i class="material-icons">picture_as_pdf</i> Regras de exposição e segurança MOTIC São Leopoldo</a>
            </div>
        </div>
    </div>
