...
@section('breadcrumb')
    ...
    <a href="{{route ('avaliador.edit')}}" class="breadcrumb">Dados Pessoais</a>
@endsection

@section('content')

@section('titulo-header', 'Editar dados pessoais')
            ...
            <article class="col s12">
                ...
                <div class="row">
                    <div class="input-field col s12 m6 l6">
                        ...
                        <label data-error="Insira um nome válido!" data-success="Ok" for="name">Nome *</label>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="input-field col s12 m6 l6">
                        ...
                        <input id="cpf" class="validate tooltipped" data-position="top" data-delay="50"
                               ...
                               data-length="14" value="{{$avaliador->cpf or old('cpf')}}">
