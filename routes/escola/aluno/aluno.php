...
Route::group(['prefix' => 'escola/aluno', 'namespace' => 'Escola\Aluno'], function () {
    ...
    Route::any('filtrar', ['as' => 'escola.aluno.filtrar', 'uses' => 'EscolaAlunoController@filtrar']);

    Route::post('store', ['as' => 'escola.aluno.store', 'uses' => 'EscolaAlunoController@store']);

    Route::get('certificados', ['as' => 'escola.aluno.certificados', 'uses' => 'EscolaAlunoController@indexCertificadosAlunos']);
});
