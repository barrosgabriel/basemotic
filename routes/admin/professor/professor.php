...
Route::group(['prefix' => 'admin/professor', 'namespace' => 'Admin\Professor'], function () {
    ...
    Route::get('tabela-certificados', ['as' => 'admin.professor.tabelaCertificado', 'uses' => 'AdminProfessorController@indexCertificados']);
    ...
    /*   novo */
    Route::get('tabela-certificados/orientadores', ['as' => 'admin.professor.tabelaCertificadoOrientadores', 'uses' => 'AdminProfessorController@indexCertificadosOrientadores']);

    Route::get('tabela-certificados/coorientadores', ['as' => 'admin.professor.tabelaCertificadoCoorientadores', 'uses' => 'AdminProfessorController@indexCertificadosCoorientadores']);
});
