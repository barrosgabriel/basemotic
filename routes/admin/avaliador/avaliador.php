...
Route::group(['prefix' => 'admin/avaliador', 'namespace' => 'Admin\Avaliador'], function () {
    ...
    Route::get('/validaAvaliadores', ['as' => 'admin.valida.avaliadores', 'uses' => 'AdminAvaliadorController@avaliadoresValidacao']);

    Route::get('/liberaAvaliadores/{id}', ['as' => 'admin.valida.avaliadores.liberar', 'uses' => 'AdminAvaliadorController@avaliadoresLiberar']);

 /*    Route::get('/showAvaliadores/{id}', ['as' => 'admin.valida.avaliadores.show', 'uses' => 'AdminAvaliadorController@avaliadoresShow']); */

    //novo
    Route::get('tabela-certificados', ['as' => 'admin.avaliador.tabelaCertificado', 'uses' => 'AdminAvaliadorController@indexCertificados']);
    ...
    Route::get('desativar-avaliador-individual/{id}', ['as' => 'admin.avaliador.desativar-avaliador-individual', 'uses' => 'AdminAvaliadorController@desativarAvaliadoresIndividual']);
});
